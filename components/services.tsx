      ...
      <div className="max-w-6xl min-h-[90vh] mx-auto my-27 px-4 sm:px-6">
        <div className="py-12 md:py-20 pb-12 md:pb-20 border-t [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1]">
          ...
          <Spotlight className="lg:max-w-none max-w-3xl mx-auto items-start gap-6 grid md:grid-cols-2 lg:grid-cols-3 group">
            {/* Card 1 */}
            <div className="before:w-80 after:w-64 h-full before:h-80 after:h-64 overflow-hidden p-px group/card before:-top-40 after:-top-48 before:-left-40 after:-left-48 before:z-10 after:z-30 before:absolute after:absolute relative bg-gray-800 before:bg-indigo-500/8 after:bg-indigo-100 before:opacity-0 after:opacity-0 hover:after:opacity-20 group-hover:before:opacity-100 before:blur-3xl after:blur-3xl rounded-2xl before:rounded-full after:rounded-full before:transition-opacity after:transition-opacity before:translate-x-[var(--mouse-x)] before:translate-y-[var(--mouse-y)] after:translate-x-[var(--mouse-x)] after:translate-y-[var(--mouse-y)] before:duration-500 after:duration-500 before:pointer-events-none after:pointer-events-none">
